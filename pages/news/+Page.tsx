...
const news = [
  {
    ...
    excerpt: 'Анализируем основные изменения в подходах к стратегическому планированию и их влияние на бизнес-процессы.',
    date: '15 января 2024',
    category: 'Стратегия',
    image: '📊',
    readTime: '5 мин'
  },
  {
    ...
    excerpt: 'Практические рекомендации по повышению эффективности финансового управления в нестабильных экономических условиях.',
    date: '10 января 2024',
    category: 'Финансы',
    image: '💰',
    readTime: '7 мин'
  },
  {
    ...
    excerpt: 'Пошаговое руководство по успешной цифровой трансформации компании с минимальными рисками.',
    date: '5 января 2024',
    category: 'Инновации',
    image: '🚀',
    readTime: '8 мин'
  },
  {
    ...
    excerpt: 'Эффективные методы управления изменениями и преодоления сопротивления персонала при внедрении новых процессов.',
  ...
  },
  {
    ...
    excerpt: 'Обзор ключевых показателей эффективности, которые помогают принимать обоснованные управленческие решения.',
  ...
  },
  {
    ...
    excerpt: 'Как внедрить клиентоориентированный подход во все аспекты бизнеса и повысить удовлетворенность клиентов.',
...
const categories = ['Все', 'Стратегия', 'Финансы', 'Инновации', 'Управление', 'Аналитика', 'Маркетинг']
